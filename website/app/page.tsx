    ...
    <>
      ...
      <nav className="fixed inset-x-0 top-0 z-50 bg-white/90 backdrop-blur-md border-b border-zinc-100">
        <div className="max-w-6xl mx-auto flex items-center justify-between h-16 px-6">
          <div className="flex items-center gap-2.5">
            ...
            <span className="text-lg font-bold text-[#2ABFBF]">Stampworth</span>
          </div>
          <div className="hidden md:flex items-center gap-8 text-sm font-medium text-[#8A94A6]">
            <a href="#features" className="hover:text-[#2ABFBF] transition">Features</a>
            <a href="#customers" className="hover:text-[#2ABFBF] transition">For Customers</a>
            <a href="#business" className="hover:text-[#2ABFBF] transition">For Business</a>
            <a href="#pricing" className="hover:text-[#2ABFBF] transition">Pricing</a>
          </div>
          <a href="#download" className="bg-gradient-to-r from-[#2ABFBF] to-[#E8734A] text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:opacity-90 transition">
            Get Started
          </a>
        </div>
      </nav>
      ...
      <main>
        ...
        <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-blue-50/60 to-white">
          <div className="max-w-6xl mx-auto text-center">
            ...
            <h1 className="max-w-3xl mx-auto">
              <span className="block text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#2ABFBF]">Stampworth</span>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
              <a href="https://drive.google.com/drive/folders/1w0cLzPnKykE_H5OFHgysPbtGm3ytCzvd?usp=drive_link" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-[#2ABFBF] to-[#E8734A] text-white text-base font-semibold px-8 py-3.5 rounded-2xl hover:opacity-90 transition shadow-lg shadow-[#E8734A]/20">
                Download APK
              </a>
        ...
        <section id="features" className="py-24 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-sm font-semibold text-[#2ABFBF] uppercase tracking-wider mb-3">How it works</p>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={item.step} className="bg-zinc-50 rounded-2xl p-8 text-center border border-zinc-100">
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-[#2ABFBF] to-[#E8734A] text-white text-sm font-bold mb-4">{item.step}</div>
        ...
        <section id="customers" className="py-24 px-6 bg-gradient-to-b from-zinc-50 to-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-sm font-semibold text-[#2ABFBF] uppercase tracking-wider mb-3">For Customers</p>
        ...
        <section id="business" className="py-24 px-6 bg-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-sm font-semibold text-[#2ABFBF] uppercase tracking-wider mb-3">For Business Owners</p>
            ...
            <div className="mt-12 bg-gradient-to-r from-[#1A2A42] to-[#2F4366] rounded-2xl p-8 sm:p-12 text-center text-white">
        ...
        <section id="pricing" className="py-24 px-6 bg-zinc-50">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-sm font-semibold text-[#2ABFBF] uppercase tracking-wider mb-3">Pricing</p>
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { name: "Beta", price: "Free", period: "during beta", color: "#2ABFBF", current: true, features: ["Unlimited everything", "All features unlocked", "No credit card needed"] },
                ...
                <div key={plan.name} className={`bg-white rounded-2xl p-6 border-2 ${plan.current ? "border-[#2ABFBF] shadow-lg shadow-[#2ABFBF]/20" : "border-zinc-200"} relative`}>
                  {plan.current && <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#2ABFBF] to-[#E8734A] text-white text-xs font-bold px-4 py-1 rounded-full">CURRENT</div>}
        ...
        {/* Download */}
        <section id="download" className="py-24 px-6 bg-gradient-to-br from-[#1A2A42] via-[#2F4366] to-[#1A2A42]">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-8 mb-10">
            ...
            <div className="flex gap-8 text-sm text-[#8A94A6]">
              <div className="flex flex-col gap-2">
                <p className="text-xs font-semibold text-[#2ABFBF] uppercase tracking-wider">Product</p>
                <a href="#features" className="hover:text-[#2ABFBF] transition">Features</a>
                <a href="#pricing" className="hover:text-[#2ABFBF] transition">Pricing</a>
                <a href="#download" className="hover:text-[#2ABFBF] transition">Download</a>
              </div>
              <div className="flex flex-col gap-2">
                <p className="text-xs font-semibold text-[#2ABFBF] uppercase tracking-wider">Legal</p>
                <a href="/privacy" className="hover:text-[#2ABFBF] transition">Privacy Policy</a>
                <a href="/terms" className="hover:text-[#2ABFBF] transition">Terms of Service</a>
              </div>
            </div>
          </div>
