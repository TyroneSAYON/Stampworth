    ...
    <>
      ...
      <nav className="fixed inset-x-0 top-0 z-50 bg-white/90 backdrop-blur-md border-b border-zinc-100">
        <div className="max-w-6xl mx-auto flex items-center justify-between h-16 px-6">
          ...
          <a href="#download" className="bg-gradient-to-r from-[#2F4366] to-[#4A7AB5] text-white text-sm font-semibold px-5 py-2.5 rounded-xl hover:opacity-90 transition">
            Get Started
          </a>
        </div>
      </nav>
      ...
      <main>
        ...
        <section className="pt-32 pb-20 px-6 bg-gradient-to-b from-blue-50/50 to-white">
          <div className="max-w-6xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 bg-white border border-zinc-200 rounded-full px-4 py-1.5 text-sm font-medium text-[#8A94A6] mb-8 shadow-sm">
              <span className="w-2 h-2 rounded-full bg-[#2F4366]" />
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-10">
              <a href="https://drive.google.com/drive/folders/1w0cLzPnKykE_H5OFHgysPbtGm3ytCzvd?usp=drive_link" target="_blank" rel="noopener noreferrer" className="bg-gradient-to-r from-[#2F4366] to-[#4A7AB5] text-white text-base font-semibold px-8 py-3.5 rounded-2xl hover:opacity-90 transition shadow-lg shadow-[#2F4366]/20">
                Download APK
              </a>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={item.step} className="bg-zinc-50 rounded-2xl p-8 text-center border border-zinc-100">
                  <div className="inline-flex items-center justify-center w-10 h-10 rounded-full bg-gradient-to-r from-[#2F4366] to-[#4A7AB5] text-white text-sm font-bold mb-4">{item.step}</div>
        ...
        <section id="customers" className="py-24 px-6 bg-gradient-to-b from-zinc-50 to-white">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <p className="text-sm font-semibold text-[#2F4366] uppercase tracking-wider mb-3">For Customers</p>
        ...
        <section id="pricing" className="py-24 px-6 bg-zinc-50">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                { name: "Beta", price: "Free", period: "during beta", color: "#2F4366", current: true, features: ["Unlimited everything", "All features unlocked", "No credit card needed"] },
                ...
                <div key={plan.name} className={`bg-white rounded-2xl p-6 border-2 ${plan.current ? "border-[#2F4366] shadow-lg shadow-[#2F4366]/20" : "border-zinc-200"} relative`}>
                  {plan.current && <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-[#2F4366] to-[#4A7AB5] text-white text-xs font-bold px-4 py-1 rounded-full">CURRENT</div>}
